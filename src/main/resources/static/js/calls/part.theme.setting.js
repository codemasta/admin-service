...
$(function () {
    ...
    if (switcheryFixedHeader) var btnFixedHeader = new Switchery(switcheryFixedHeader, {
        color: successColor,
        size: 'small'
    });
    if (switcheryStickyHeader) var btnStickyHeader = new Switchery(switcheryStickyHeader, {
        color: successColor,
        size: 'small'
    });
    if (switcheryFixedFooter) var btnFixedFooter = new Switchery(switcheryFixedFooter, {
        color: warningColor,
        size: 'small'
    });
    if (switcheryStickyFooter) var btnStickyFooter = new Switchery(switcheryStickyFooter, {
        color: warningColor,
        size: 'small'
    });
